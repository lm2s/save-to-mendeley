// This script was extracted verbatim from Mendeley bookmarklet.
// All rights belong to Mendeley.
// Copyright (C) Mendeley
(function MendeleyBookmarklet() {
    ...
    function run() {
        ...
        var mendeleyHroot = "https://www.mendeley.com"; //source.match(/^https?:\/\/[^/]+/);
